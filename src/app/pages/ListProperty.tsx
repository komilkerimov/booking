  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f5f0e8", paddingTop: 70 }}>
      <div className="relative overflow-hidden" style={{ background: "#0d1b2a", padding: "56px 24px" }}>
        <img src="https://images.unsplash.com/photo-1646991761123-d83ce47c30c9?w=1600&q=80" alt="" className="absolute inset-0 w-full h-full object-cover" style={{ opacity: 0.5 }} />
