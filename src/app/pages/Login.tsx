    ...
    <div className="min-h-screen flex" style={{ background: "#f5f0e8" }}>
      ...
      >
        ...
        <div className="flex gap-2">
          {[
            "https://images.unsplash.com/photo-1664602078796-68ee76b3fc59?w=200&h=130&fit=crop",
            "https://images.unsplash.com/photo-1774851431070-f1cbba496e41?w=200&h=130&fit=crop",
            "https://images.unsplash.com/photo-1629140727571-9b5c6f6267b4?w=200&h=130&fit=crop",
          ].map((src, i) => (
