  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f5f0e8", paddingTop: 70 }}>
      ...
      <div className="relative overflow-hidden py-20 px-6" style={{ background: "#0d1b2a" }}>
        <img src="https://images.unsplash.com/photo-1715540335937-f54bf332585a?w=1600&q=80" alt="" className="absolute inset-0 w-full h-full object-cover" style={{ opacity: 0.52 }} />
